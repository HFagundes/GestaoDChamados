...
namespace ChamadosApp
{
    public class LoginForm : Form
    {
        ...
        private void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                usernameAutenticado = user; // Armazena o usu�rio autenticado
                MessageBox.Show("Login efetuado com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                AdminForm adminForm = new AdminForm(); // Passa o usu�rio para o AdminForm
                adminForm.Show();
                this.Hide();
            }
            ...
            {
                usernameAutenticado = user; // Armazena o usu�rio autenticado
                UsuarioForm usuarioForm = new UsuarioForm(usernameAutenticado); // Passa o usu�rio para o UsuarioForm
                usuarioForm.Show();
                this.Hide();
            }
            else
